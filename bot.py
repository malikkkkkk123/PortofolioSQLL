...
#bot_event on ready - memberitahu sudah online
@bot.event
async def on_ready():
...
#!info - untuk memberitahu perintah perintah yang ada
...
#!new_project - buat project baru, disuruh isi nama, link, dan status
...
#!get_projects - buat manggil database project tersebut sesuai nama yang kamu sebut
...
#!skills - nambahin skills ke project yang disebut
...
#!delete - menghapus project yang disebut
...
async def delete_project(ctx):
    ...
    if projects:
        ...
        await ctx.send('Kamu belum memiliki proyek!\nKamu dapat menambahkannya menggunakan perintah !new_project')
#!update_projects - mengubah suatu hal yang ada di dalam project sesuai pilihan mu
